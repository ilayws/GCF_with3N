...
// Acceptance (binary, unweighted) for CLAS6
// Determines if a particle is detected. To accept/reject, use functions "accept_proton", "accept_electron", etc. 
...
bool accept_electron(TVector3 p)
{
 ...
 // cout << "Phi in acceptance: " << phi << endl;
