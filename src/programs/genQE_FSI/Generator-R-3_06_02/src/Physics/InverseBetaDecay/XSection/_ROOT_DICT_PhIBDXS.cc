...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,const genie::XSecAlgorithmI*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,const genie::XSecAlgorithmI*>", -2, "map", 102,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("map<int,const genie::XSecAlgorithmI*>","std::map<int, genie::XSecAlgorithmI const*, std::less<int>, std::allocator<std::pair<int const, genie::XSecAlgorithmI const*> > >"));
      return &instance;
   }
   // Static variable to force the class initialization
...
"/opt/root-install/include/root",
"/home/ilayws/Ilay-Generators/src/programs/genQE_FSI/Generator-R-3_06_02/src/Physics/InverseBetaDecay/XSection/",
nullptr
    };
